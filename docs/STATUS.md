...
| U04 | Task 3 — bridge config | M1 | NEXT | `feat/tb-t03-bridge-config` | — | 0/34 | — | — |
...
**Unit tests passing overall:** 51 / ~187 (running total, `pytest --collect-only`). U01: 1 planned → 3; U02: 7 planned → 10; U03: 20 planned → 38 (grew across two review rounds; see §2). Later units' "planned" counts in this table are the plan's original estimates and will likely grow the same way once reviewed.
